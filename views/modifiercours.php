    ...
    <div class="max-w-2xl mx-auto bg-white p-8 rounded-lg shadow">
        ...
        <form action="../action/EnseignantActions.php" method="GET" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <textarea id="contenu" name="contenu" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300">
            ...
            <div class="mb-4">
                ...
                <input type="number" id="id_category" name="id_category" 
                value="<?php echo $idcours['id_category']; ?>" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300">
            </div>
            <div class="mb-4">
                <label for="id_tag" class="block text-gray-700 font-semibold">Tag ID:</label>
                <input type="number" id="id_tag" name="id_tag"
                 value="<?php echo $idcours['id_tag']; ?>" class="w-full px-3 py-2 border rounded-lg focus:outline-none focus:ring focus:border-blue-300">
            </div>
